...
name: gitlab
description: >-
  Use this skill when the user needs to work with GitLab from the terminal — managing merge requests,
  issues, pipelines, or releases via glab CLI. Also use when creating or debugging .gitlab-ci.yml
  pipelines, configuring CI/CD variables, stages, jobs, rules, caching, or artifacts, even if
  they don't explicitly mention "GitLab" or "glab".
---
