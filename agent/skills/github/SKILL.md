...
name: github
description: >-
  Use this skill when the user needs to work with GitHub from the terminal — checking PR status,
  viewing CI failures, managing issues, or optimizing GitHub Actions workflows. Also use when
  the user asks about caching, artifacts, matrix builds, runner sizing, or workflow triggers,
  even if they don't explicitly mention "GitHub Actions" or "gh CLI".
---
